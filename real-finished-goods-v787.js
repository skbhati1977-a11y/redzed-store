(() => {
  ...
  const state = { profile:null, packPlan:null, packLots:[], packWorkers:[], selectedPack:null, readyBoxes:[], receiveBoxes:[], piId:null, piLines:[], stock:[], cpis:[], mode:params.get('mode')==='REAL'?'REAL':'TEST', mountedLot:(params.get('lot')||'').trim() };
