...
function patchAtomicSubmit(){
 if(!['PRINTING','STICKER','METAL_ID'].includes(dept))return;const m=document.getElementById('rfSubmitModal'),btn=m?.querySelector('#rfDoSubmit');if(!m||!btn||m.dataset.rr9160Atomic==='1'||m.dataset.rr9160!=='1')return;if(m.querySelector('#rfSubmitLM')){m.dataset.rr9160Atomic='1';return}m.dataset.rr9160Atomic='1';
