-- REAL FACTORY SALARY VOUCHER NUMBER-ONLY DISPLAY V786.3.21
...
begin
  ...
  return jsonb_build_object(
    ...
    'display_text',concat(v_prefix,v_next),
...
then 'PASS' else 'FAIL' end as salary_voucher_display_v786_3_21_result;
