(()=>{
  ...
  async function rpcRetry(name,args={}){try{return await rpc(name,args)}catch(e){if(!isAbort(e))throw e;await new Promise(r=>setTimeout(r,700));return await rpc(name,args)}}
