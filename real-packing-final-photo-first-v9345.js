(()=>{
  'use strict';
  if(window.__RR_PACKING_FINAL_PHOTO_FIRST_V9353__)return;
  window.__RR_PACKING_FINAL_PHOTO_FIRST_V9353__=true;
  ...
  async function compactImage(file){
    ...
    if(file.size>10*1024*1024)throw Error('Photo heavy hai. Crop/screenshot karke 10MB se kam photo select karein.');
    return file;
  }
