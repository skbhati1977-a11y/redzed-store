(() => {
"use strict";
window.REDZED_ROLE_PERMISSION_VERSION="773.1.0";
...
function witnessOptionsV773(workerId,selected=""){
  const candidates=witnessCandidates(workerId);

  return `
    <option value="">
      ${candidates.length
        ?"Select active Login-Linked Witness"
        :"Koi active Login-Linked Witness available nahi"}
    </option>
    ${candidates.map(w=>`
