/* V9309/V9345 — locked FG Packing algorithm + manager behalf + Ready Lots REST bridge + final-photo-first RRQ flow. */
(()=>{
  'use strict';
  ...
  function retryReadyLotsIfStuck(){
    ...
    if(stuck){const b=document.getElementById('refreshPackLots');if(b&&!b.disabled)b.click();}
  }
  ...
  function loadPicEngine(){if(!/real-finished-goods-v787\.html/i.test(location.pathname))return;loadScript('rrPackingPicEngineV9330','/redzed-store/real-packing-pic-engine-v9330.js?v=9332');loadScript('rrPackingFinalPhotoFirstV9345','/redzed-store/real-packing-final-photo-first-v9345.js?v=9345');}
