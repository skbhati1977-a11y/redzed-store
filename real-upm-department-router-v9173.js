...
const NAMES={PRINTING:'Print',STICKER:'Sticker',METAL_ID:'Metal ID',STITCHING:'Karigar / Stitching',KAAJ:'Kaaj',BUTTON:'Button',OVERLOCK:'Overlock',FOLDING:'Folding',THREAD_CUT:'Thread Cutting',QC:'QC',PRESS:'Press',PACKING:'Packing'};
