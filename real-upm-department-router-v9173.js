(()=>{
'use strict';
const ALIAS={KR:'STITCHING',KARIGAR:'STITCHING',STITCH:'STITCHING',STITCHING:'STITCHING',OV:'OVERLOCK',OVERLOCK:'OVERLOCK',FLD:'FOLDING',FLATLOCK:'FOLDING',FOLDING:'FOLDING',KAAJ:'KAAJ_BUTTON',KAJ:'KAAJ_BUTTON',BUTTON:'KAAJ_BUTTON',BTN:'KAAJ_BUTTON',THREAD_CUT:'THREAD_CUT',THREAD_CUTTING:'THREAD_CUT',TH_CUT:'THREAD_CUT',QC:'QC',CHECKING:'QC',PRESS:'PRESS',FINISHING:'PRESS',PRINT:'PRINTING',PRINTING:'PRINTING',STICKER:'STICKER',ID:'METAL_ID',ID_WORK:'METAL_ID',METAL_ID:'METAL_ID',PACK:'PACKING',PACKING:'PACKING',DISPATCH:'DESPATCH',DESPATCH:'DESPATCH'};
const ACTIVE=new Set(['PRINTING','STICKER','METAL_ID','STITCHING','OVERLOCK','FOLDING','KAAJ_BUTTON','THREAD_CUT','QC','PRESS','PACKING','DESPATCH']);
const NAMES={PRINTING:'Print',STICKER:'Sticker',METAL_ID:'Metal ID',STITCHING:'Karigar / Stitching',KAAJ_BUTTON:'Kaaj / Btn',DESPATCH:'Despatch',OVERLOCK:'Overlock',FOLDING:'Folding',THREAD_CUT:'Thread Cutting',QC:'QC',PRESS:'Press',PACKING:'Packing'};
