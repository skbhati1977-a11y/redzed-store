...
if(rrIsDashboardPath(window.location.pathname)){
 const pinLatestDashboardRoutes=()=>{
  document.querySelectorAll('a[href]').forEach(a=>{
   ...
   else if(text==='worker real chat'||text.includes('worker real chat'))a.href=`${RR_REPO_BASE}test70-cb-purchase-real-chat-pilot.html?v=70`;
