 ...
 * File        : config.js
 * Recovery ID : RR-005
 * Status      : RECOVERED · V9301 COSTING/RRQ DASHBOARD
 ******************************************************************/
...
if(!rrIsDashboardPath(window.location.pathname)&&!window.__RR_SLICE_MENU_LOADER_9301__){window.__RR_SLICE_MENU_LOADER_9301__=true;const nav=document.createElement('script');nav.src=`${RR_REPO_BASE}real-global-slice-menu-v9190.js?v=${RR_TRAVEL_VERSION}`;nav.async=false;(document.head||document.documentElement).appendChild(nav)}
