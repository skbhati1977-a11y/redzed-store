...
if(/\/real-finished-goods-v787\.html$/i.test(window.location.pathname)){const p=document.createElement("script");p.src=`${RR_REPO_BASE}real-packing-manager-behalf-v9309.js?v=9360`;p.async=false;document.head.appendChild(p)}
