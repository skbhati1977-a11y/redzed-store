...
$('rrAssignSave').disabled=true;$('rrAssignSave').textContent='ASSIGNING…';await rpc('rr_upm_assign_colours_v8_3',{p_canonical_lot_id:state.lotId||null,p_lot_no:state.lotNo||null,p_department_code:state.department,p_rows:rows,p_remarks:$('rrAssignRemarks').value||null});
