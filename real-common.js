...
(()=>{
  ...
  const installPermanentGlobalGuards=()=>{
    ...
    style.textContent='.rr-gsheet-toolbar{display:none!important}.rr-gsheet-filter-btn{display:none!important}#rrGsheetBottomScrollV775{display:none!important}';
