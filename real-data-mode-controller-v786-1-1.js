...
function installPhaseBadge(state){
  ...
  if(!badge){
    ...
    badge.href='real-data-mode-control-v786.html?v=896';
    ...
    Object.assign(badge.style,{
      ...
      fontSize:'12px',
      fontWeight:'900',
      boxShadow:'0 7px 24px rgba(0,0,0,.38)',
  ...
  if(state.lifecycle_phase==='REAL_LIVE'){
    badge.textContent='REAL LIVE · TEST PROTECTED';
    badge.style.background='#145c3c';
  }else{
    badge.textContent='TEST DEFAULT · REAL PROTECTED';
    badge.style.background='#744c12';
  }
}
