-- TEST71 V623: deterministic, isolated browser fixtures for the canonical
  ...
  if v_cb is null then
    ...
    v_payload:=jsonb_build_object(
      ...
      'colours',jsonb_build_array(jsonb_build_object(
        ...
        'image_url','https://example.invalid/test71-v623.jpg',
        'confirmed',true
      )),
...
comment on function public.rr_test_cb_ui_fixture_v619(text,uuid) is
  'TEST71 V623 authenticated browser fixture. SETUP/READY use canonical CB and Product Master writers; RETIRE uses canonical Purchase Return, preserves immutable TEST history, and removes active App/Real Chat/Cutting projections.';
